...
class TestTargetBudgetConverter(TestCase):
    """Tests for TargetBudgetConverter"""

    def test_percentage_to_nominal_conversion(self):
    ...
    def test_hundred_percent_returns_same_total(self):
        current_total = Decimal("1000000")
